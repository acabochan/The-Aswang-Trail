...
public class MON_Engkanto extends Entity{
	GamePanel gp;

	public MON_Engkanto(GamePanel gp) {
		super(gp);
	...
	public void getImage() {
		...
		Left1 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Left2 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);
		Left3 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Left4 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);
		Left5 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Left6 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);
		Left7 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Left8 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);

		Right1 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Right2 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);
		Right3 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Right4 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);
		Right5 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Right6 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);
		Right7 = setup("/monster/Engkanto1",gp.tileSize,gp.tileSize);
		Right8 = setup("/monster/Engkanto2",gp.tileSize,gp.tileSize);
